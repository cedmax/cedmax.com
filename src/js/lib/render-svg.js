define(['lib/helpers'], function(helpers) {
  ...
  return function(referenceImg, ratio, position) {
    ...
    return function() {
      ...
      var patternHeight = imgHeight * svgResizeRatio;
      var patternTop = -offset.top * svgResizeRatio;
      ...
      switch (position) {
        ...
        case 'right':
          patternLeft =
            (viewPortSize.x - imgWidth - offset.left) * svgResizeRatio;
          break;
        default:
      ...
      svg.outerHTML =
        '<svg id="ced" viewBox="0 0 ' +
        SVG_SIZE_W +
        ' ' +
        SVG_SIZE_H +
        '"><pattern id="mypattern" patternUnits="userSpaceOnUse" width="' +
        patternWidth +
        '" height="' +
        patternHeight +
        '"><svg id="innerced"><image width="' +
        patternWidth +
        '" height="' +
        patternHeight +
        '" xlink:href="' +
